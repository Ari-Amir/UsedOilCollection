...
class RegistrationTest {
    ...
    fun test_Registration() {
        ...
        device.findObject(UiSelector().resourceId("com.aco.usedoilcollection:id/toggle_button")).click()
        device.findObject(UiSelector().resourceId("com.aco.usedoilcollection:id/name_field")).setText(TEST_USER_NAME)
